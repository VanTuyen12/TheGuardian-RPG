...
public class InventoryTester : MyMonoBehaviour
{
    ...
    {
        InventoryCtrl inventoryCtrl1 = InventoryManager.Instance.GetByName(InvCodeName.Monies);
    ...
    {
        InventoryCtrl inventoryCtrl1 = InventoryManager.Instance.GetByName(InvCodeName.Items);
